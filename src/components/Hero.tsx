          ...
          <div className="order-2 md:order-1">
            ...
            >
              ...
              >
                ...
                AI-Powered App & Web Development Studio
              </motion.div>
              ...
              <div>
                ...
                >
                  Our AI-powered development process delivers high-quality apps and websites in <span className="font-bold text-custom-blue">half the time and cost</span> of traditional development.
                </motion.p>
              </div>
              ...
              <motion.div
                ...
                className="pt-6 flex flex-col items-center w-full"
              >
                <motion.button 
                  onClick={() => setIsIdeaCaptureOpen(true)}
                  className="group relative inline-flex items-center justify-center px-6 sm:px-8 py-3 sm:py-4 text-base sm:text-lg font-medium text-white bg-gradient-to-r from-custom-blue to-blue-600 rounded-full overflow-hidden transition-all hover:scale-105 hover:shadow-xl hover:shadow-custom-blue/30 w-full"
                ...
                <p className="text-sm text-custom-blue mt-2 animate-pulse">
                  ✨ Try our AI-powered Idea Wizard and get instant feedback! ✨
                </p>
              </motion.div>
            </motion.div>
          </div>
